    ...
    <div class="card-body">
        <form action="{{ route('guru.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nama" name="nama" placeholder="Masukkan Nama Guru" value="{{ old('nama') }}" max="100">
                @error('nama')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="nip" name="nip" placeholder="Masukkan NIP" value="{{ old('nip') }}" max="8">
                @error('nip')
                    <div class="text-danger">{{ $message }}</div>
                @enderror
            </div>
